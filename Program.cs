...
namespace CSharp_CheatSheet
{
    public class Program
    {
            ...
            switch (valueInputOperator)
            {
                ...
                case 3: // Grouping Operators (GroupBy ToLookup)
                    ...
                    switch (valueInputGroupingOperator)
                    {
                        case 1:
                            // GroupBy Query
                            LINQGroupByFunctionQuery(studentList);
                            break;
                        case 2:
                            // GroupBy Method
                            LINQGroupByFunctionMethod(studentList);
                            break;
                        case 3:
                            // ToLookUp
        ...
        public static void LINQGroupByFunctionQuery(IList<Student> studentList){
        ...
        public static void LINQGroupByFunctionMethod(IList<Student> studentList){

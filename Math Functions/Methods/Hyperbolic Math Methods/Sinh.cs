...
namespace CSharp_CheatSheet.MathFunctions.Methods.HyperbolicMathMethods
{
    public class Sinh
    {
        public static void SinhMain()
        {
            Console.WriteLine("--- Sinh ---");
            Console.WriteLine("Returns the hyperbolic sine of a value\n");
            ...
            {
                Console.WriteLine("Hyperbolic sine of {0} is {1}.", number, Math.Sinh(number));
            }
        }
    }
}
